    ...
    >
      ...
      >
        <div className="pb-8 ">
          ...
          <p className="py-6">Submit the form below or send me an e-mail</p>
        </div>
        <div className="flex justify-center items-center">
          <form
            action="https://getform.io/f/61b5c7b5-989a-4f92-b7b9-71e5c819d6d0"
            method="POST"
